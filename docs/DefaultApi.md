...
------------- | ------------- | -------------
[**add_to_cart**](DefaultApi.md#add_to_cart) | **POST** /api/albums/addToCart | 
...
[**find_albums_by_song_title**](DefaultApi.md#find_albums_by_song_title) | **GET** /api/albums/{songTitle} | 
...
with openapi_client.ApiClient() as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.clear_shopping_cart(authorization=authorization)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
with openapi_client.ApiClient() as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.display_shopping_cart(authorization=authorization)
        pprint(api_response)
    except openapi_client.ApiException as e:
...
with openapi_client.ApiClient() as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.find_albums_by_song_title(song_title, authorization=authorization)
        pprint(api_response)
    except openapi_client.ApiException as e:
        print("Exception when calling DefaultApi->find_albums_by_song_title: %s\n" % e)
```
