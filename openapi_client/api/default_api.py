...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.buy_products_web_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/api/shoppingCart/buyProductsWeb',
                'operation_id': 'buy_products_web',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.find_albums_by_song_title_endpoint = _Endpoint(
            settings={
                'response_type': ([AlbumDTO],),
                'auth': [],
                'endpoint_path': '/api/albums/digital/{songTitle}',
        ...
        self.find_albums_by_song_title_physical_endpoint = _Endpoint(
            settings={
                'response_type': ([AlbumDTO],),
                'auth': [],
                'endpoint_path': '/api/albums/physical/{songTitle}',
        ...
        self.remove_line_item_from_cart_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/api/shoppingCart/removeLineItemFromCart',
                'operation_id': 'remove_line_item_from_cart',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def buy_products_web(
        self,
        **kwargs
    ):
        """buy_products_web  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.buy_products_web(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.buy_products_web_endpoint.call_with_http_info(**kwargs)
    ...
    def remove_line_item_from_cart(
        self,
        **kwargs
    ):
        """remove_line_item_from_cart  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.remove_line_item_from_cart(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.remove_line_item_from_cart_endpoint.call_with_http_info(**kwargs)
